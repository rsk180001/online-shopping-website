...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 26, 2019 at 02:31 AM
...
(6, '::1', 'Rushikesh Kulkarni', 'rsk180001@utdallas.edu', 'B3/14@ganesh', 'Canada', 'Dallas', '6825518039', '7740, McCallum blvd, 270', '00-01-08-Cf7j09YUMAEhlGG.jpg', 0),
(7, '::1', 'Rushikesh Kulkarni', 'rsk180001@utdallas.edu', '$2y$10$OoAbE4OKWWH8zHK7EUFbtO1gyGrnpN5R5KrGTgi1fFIqNag.QQrfi', 'USA', 'Dallas', '6825518039', '7740, McCallum blvd, 270', 'IMG_20160218_103904.jpg', 0),
(1234, '::1', 'nikhil', 'nlk180002@utdallas.edu', '12345', 'india', 'pune', '7747378083', '290 shaniwar peth', '', 1),
(1235, '::1', 'Nikhil NotAdmin', 'nikhilkalekar17oct@gmail.com', '$2y$10$4amiMhmV9hojZLM9Cuxrmu46Z6a75TjR/dcPSeElhYlkZ1L4jTFSS', 'USA', 'Richardson', '7757787890', 'bla bla', 'michael-larosa-449701-unsplash.jpg', 0);
...
(6, 4, 3, 'imac book big', 2100, 'big mac book', '71KyjhnQY4L._SY355_.jpg', 'mac book, apple'),
(7, 1, 2, 'Dell laptop new', 688, 'its very new condition laptop', 'download.jpg', 'dell, new, 10/10'),
...
--
ALTER TABLE `customers`
  MODIFY `cust_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1236;
